...
export function SocialProof2() {
  return (
    <p className="paragraph" style={{width: "80%"}}>
      ...
      supervisor for two decades, and Martha stood out immediately as a gifted therapist. 
      I could see right away that she brought a brilliance, skillfulness, and clarity to
      ...
      For a client who wants a journey of healing, growth, and expansion, they would be 
